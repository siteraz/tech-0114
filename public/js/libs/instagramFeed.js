    ...
    $.fn.instagramLite = function(options) {
        ...
        const formatCaption = function(caption) {
            ...
            for(let i = 0; i < words.length; i++) {
                ...
                if(words[i][0] == '@') {
                    a = '<a href="https://instagram.com/'+words[i].replace('@', '').toLowerCase()+'" target="_blank">'+words[i]+'</a>';
                    word = a;
                } else if(words[i][0] == '#') {
                    a = '<a href="https://instagram.com/explore/tags/'+words[i].replace('#', '').toLowerCase()+'" target="_blank">'+words[i]+'</a>';
                    word = a;
                } else {
                    word = words[i]
                }
